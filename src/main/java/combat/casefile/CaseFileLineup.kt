...
class CaseFileLineup: Battle() {
    companion object {
        private const val ATTACKER_SKILL_WAIT = 3700L
    ...
    private fun force1(): String {
        ...
        // 1号位玛尔达 技能3 降防
        stringBuilder.append(action.servantSkill(3, 1, SKILL_WAIT))
        // 点御主技能 技能3换人    4号位狂贞换1号位玛尔达
        stringBuilder.append(action.openMasterSkill())
        stringBuilder.append(action.changeServant(1, 4))
        // 1号位狂贞 技能2 技能3
    ...
    private fun force3(): String {
        ...
        stringBuilder.append(action.servantSkill(2, 2, SKILL_WAIT))
        // 3号位梅林 技能1 技能3
        stringBuilder.append(action.servantSkill(1, 3, SKILL_WAIT))
        stringBuilder.append(action.servantSkill(3, 3, 1, true, SKILL_WAIT))
        // 点御主技能   技能1解弱体
     ...
     * 不换人 借梅林
     */
    private fun force4(): String {
        // FGO国服 淑女.莱妮丝事件簿 魔神柱Monkey脚本4
        // 屏幕分辨率：1280*720
        // 阵容：
        //  1号位 狂贞（带100级醉贞）
        //  2号位 梅林（羁绊礼装）
